  ...
  return (
    <main className={classesToAdd}>
      <section className="channel-view">
        {!directMessages.isLoading || !messages.isLoading ? (
          <>
            <WorkspaceInfo />
            <Scrollbar
              color="dark"
                    ...
                    <div className="channel-view__inner">
                      ...
                      {currentChannel.description && (
                        <div className="channel-view__inner-three">
                          ...
                          <Text
                            className="channel-view__description"
                            tag="span"
                          >
                            {currentChannel.description}
                          </Text>
          ...
          <div className="channel-view__placeholder">
            <Placeholder color="dark" type="info" />
            <Placeholder color="dark" numberOfTags={5} type="message" />
          </div>
        )}
      </section>
